...
# I.e.: ./embed.sh Example README.md > README-tmp.md && mv README-tmp.md README.md
# if embedding_anchor is i.e. 'Example' then line in file_with_markdown.md:
# [Example: Creating Neo4j adapter](some/path/dir/file.java)
# means go to some/path/dir/file.java to find snippet 'Creating Neo4j adapter' and embed it.
# snippet format is:
# BEGIN_SNIPPET:Creating default Neo4j adapter
# END_SNIPPET
